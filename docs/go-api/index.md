...
# Go Bindings — [`go-bitcoinkernel`](https://github.com/stringintech/go-bitcoinkernel) (Coming Soon)

Go bindings for `libbitcoinkernel` are not yet available in this documentation.

!!! note "Want to contribute?"
    If you are familiar with Go bindings for `libbitcoinkernel`, we would love to include the documentation here. See the [contributor guide](https://github.com/yuvicc/bitcoinkernel-docs/blob/master/README.md) to learn how to add a new language section.
